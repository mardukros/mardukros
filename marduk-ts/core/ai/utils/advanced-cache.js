...
export class WeightedLRUCache {
    ...
    constructor(options) {
        ...
        this.cache = new LRUCache({
            ...
            dispose: (value, key) => {
                ...
                this.options.disposeFn?.(value, key);
            }
        });
    ...
    calculateItemScore(item) {
        ...
        // Combined score
        return ((recency * (this.options.recencyFactor || 0.6)) +
     ...
     */
    shouldExtendTtl(item) {
        if (!this.options.ttlExtensionOnHit)
            return false;
    ...
    set(key, value) {
        ...
        this.cache.set(key, enhancedValue, { ttl });
    }
    /**
