...
import { MemorySubsystemAdapter } from './context-sources.js';
/**
...
export class UserActivityAdapter {
    ...
    recordActivity(description, type, tags) {
    ...
    async getContext(query, options) {
        ...
        const matchingActivities = this.activities
            ...
            const matches = searchTerms.some(term => activity.description.toLowerCase().includes(term) ||
